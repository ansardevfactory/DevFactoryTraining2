...
function EditProject() {
  ...
  useEffect(()=>{
   ...
   var url1=" https://0kcgyqm6ra.execute-api.us-west-2.amazonaws.com/editproject_selectedproject";
        ...
        <div className="outer_row2">
          ...
          <div className="outer_column2">
            ...
            <div className="column2_row3_2">
              ...
              <div><select className="project_select" value={owner}  onChange={(e)=>{setRefOwner(e.target.value)}}>
